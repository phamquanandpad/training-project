...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\x03R\x06userId2\xa5\x02\n" +
	"\vAuthService\x128\n" +
	"\x05Login\x12\x15.auth.v1.LoginRequest\x1a\x16.auth.v1.LoginResponse\"\x00\x12A\n" +
	"\bRegister\x12\x18.auth.v1.RegisterRequest\x1a\x19.auth.v1.RegisterResponse\"\x00\x12M\n" +
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x1d.auth.v1.RefreshTokenResponse\"\x00\x12J\n" +
	"\vVerifyToken\x12\x1b.auth.v1.VerifyTokenRequest\x1a\x1c.auth.v1.VerifyTokenResponse\"\x00BDZBgithub.com/phamquanandpad/training-project/grpc/go/auth/v1;auth_v1b\x06proto3"
