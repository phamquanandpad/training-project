...
ACCESS_TOKEN_EXPIRE_DURATION=900
REFRESH_TOKEN_EXPIRE_DURATION=86400
```
...
This will start the MySQL database container on port 33061.
...
The service will start on port 5007 (or the port specified in your `.env` file).
